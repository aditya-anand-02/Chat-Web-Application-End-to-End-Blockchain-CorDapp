...
import net.corda.samples.example.contracts.ChatContract;
import net.corda.samples.example.states.ChatState;
...
public class Ping {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            ChatState msgState = new ChatState(message, sendingParty, receivingParty, new UniqueIdentifier());
            final Command<ChatContract.Commands.Create> txCommand1 = new Command<>(
                    new ChatContract.Commands.Create(),
            ...
            final TransactionBuilder txBuilder1 = new TransactionBuilder(notary)
                    .addOutputState(msgState, ChatContract.ID)
            ...
            class SignTxFlow1 extends SignTransactionFlow {
                ...
                protected void checkTransaction(SignedTransaction stx) {
                    requireThat(require -> {
                        ...
                        require.using("This must be a Message transaction.", output1 instanceof ChatState);
