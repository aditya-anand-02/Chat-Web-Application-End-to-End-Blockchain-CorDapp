...
public class ChatState implements ContractState, LinearState {
    ...
    public ChatState(String msgUpdate, Party msgSender, Party msgReceiver, UniqueIdentifier linearId) {
