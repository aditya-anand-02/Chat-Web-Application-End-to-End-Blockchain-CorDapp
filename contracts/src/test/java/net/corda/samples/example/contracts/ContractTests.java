...
//                tx.output(ChatContract.ID, new ChatState(iouValue, miniCorp.getParty(), megaCorp.getParty(), new UniqueIdentifier()));
//                tx.fails();
//                tx.command(ImmutableList.of(megaCorp.getPublicKey(), miniCorp.getPublicKey()), new ChatContract.Commands.Create());
//                tx.verifies();
//                return null;
//            });
//            return null;
...
//        ledger(ledgerServices, (ledger -> {
//            ledger.transaction(tx -> {
//                tx.input(ChatContract.ID, new ChatState(iouValue, miniCorp.getParty(), megaCorp.getParty(), new UniqueIdentifier()));
//                tx.output(ChatContract.ID, new ChatState(iouValue, miniCorp.getParty(), megaCorp.getParty(), new UniqueIdentifier()));
//                tx.command(ImmutableList.of(megaCorp.getPublicKey(), miniCorp.getPublicKey()), new ChatContract.Commands.Create());
